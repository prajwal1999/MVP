...
{
MUTEX_DECL(_dotP_even_series_block_stmt_11_c_mutex_);
MUTEX_LOCK(_dotP_even_series_block_stmt_11_c_mutex_);
_dotP_even_inner_inarg_prep_macro__; 
_dotP_even_branch_block_stmt_15_c_export_decl_macro_; 
{
{
...
_dotP_even_branch_block_stmt_15_c_export_apply_macro_;
}
// 	result := (nval_even + nval_odd) $buffering 1// bits of buffering = 32. 
_dotP_even_assign_stmt_96_c_macro_; 
_dotP_even_inner_outarg_prep_macro__; 
MUTEX_UNLOCK(_dotP_even_series_block_stmt_11_c_mutex_);
}
...
{
MUTEX_DECL(_dotP_odd_series_block_stmt_98_c_mutex_);
MUTEX_LOCK(_dotP_odd_series_block_stmt_98_c_mutex_);
_dotP_odd_inner_inarg_prep_macro__; 
_dotP_odd_branch_block_stmt_101_c_export_decl_macro_; 
{
{
// do-while:   file .Aa/mvp.linked.aa, line 54
__declare_static_bit_vector(konst_173,8);\
bit_vector_clear(&konst_173);\
konst_173.val.byte_array[0] = 32;\
__declare_static_bit_vector(ULT_u8_u1_174,1);\
uint8_t do_while_entry_flag;
do_while_entry_flag = 1;
uint8_t do_while_loopback_flag;
do_while_loopback_flag = 0;
while(1) {
// merge  file .Aa/mvp.linked.aa, line 56
_dotP_odd_merge_stmt_103_c_preamble_macro_; 
// 			$phi C := 			  ($bitcast ($uint<8>) 0  ) $on   $entry 			  nC $on   $loopback 
 // type of target is $uint<8>
_dotP_odd_phi_stmt_104_c_macro_; 
// 			$phi val_even := 			  ($bitcast ($uint<32>) 0  ) $on   $entry 			  nval_even $on   $loopback 
 // type of target is $uint<32>
_dotP_odd_phi_stmt_109_c_macro_; 
// 			$phi val_odd := 			  ($bitcast ($uint<32>) 0  ) $on   $entry 			  nval_odd $on   $loopback 
 // type of target is $uint<32>
_dotP_odd_phi_stmt_114_c_macro_; 
_dotP_odd_merge_stmt_103_c_postamble_macro_; 
// 			$volatile Cr := ( $slice C 7 1 )  $buffering 1
_dotP_odd_assign_stmt_123_c_macro_; 
// 			a_rc_even := A_0[R][Cr] $buffering 1// bits of buffering = 32. 
_dotP_odd_assign_stmt_128_c_macro_; 
// 			a_rc_odd := A_1[R][Cr] $buffering 1// bits of buffering = 32. 
_dotP_odd_assign_stmt_133_c_macro_; 
// 			xval_even := x_0[Cr] $buffering 1// bits of buffering = 32. 
_dotP_odd_assign_stmt_137_c_macro_; 
// 			xval_odd := x_1[Cr] $buffering 1// bits of buffering = 32. 
_dotP_odd_assign_stmt_141_c_macro_; 
// 			$volatile nval_even := (val_even + (a_rc_even * xval_even)) $buffering 1
_dotP_odd_assign_stmt_148_c_macro_; 
// $report (dotP even 			 val_even val_even 			 a_rc_even a_rc_even 			 xval_even xval_even 			 nval_even nval_even )
_dotP_odd_stmt_153_c_macro_; 
// 			$volatile nval_odd := (val_odd + (a_rc_odd * xval_odd)) $buffering 1
_dotP_odd_assign_stmt_160_c_macro_; 
// $report (dotP odd 			 val_odd val_odd 			 a_rc_odd a_rc_odd 			 xval_odd xval_odd 			 nval_odd nval_odd )
_dotP_odd_stmt_165_c_macro_; 
// 			nC := (C + 2 ) $buffering 1// bits of buffering = 8. 
_dotP_odd_assign_stmt_170_c_macro_; 
do_while_entry_flag = 0;
do_while_loopback_flag = 1;
bit_vector_clear(&konst_173);\
konst_173.val.byte_array[0] = 32;\
bit_vector_less(0, &(nC), &(konst_173), &(ULT_u8_u1_174));\
if (has_undefined_bit(&ULT_u8_u1_174)) {fprintf(stderr, "Error: variable ULT_u8_u1_174 has undefined value (%s) at test point.\n", to_string(&ULT_u8_u1_174));assert(0);} \

if (!bit_vector_to_uint64(0, &ULT_u8_u1_174)) break;
} 
}
_dotP_odd_branch_block_stmt_101_c_export_apply_macro_;
}
// 	result := (nval_even + nval_odd) $buffering 1// bits of buffering = 32. 
_dotP_odd_assign_stmt_180_c_macro_; 
_dotP_odd_inner_outarg_prep_macro__; 
MUTEX_UNLOCK(_dotP_odd_series_block_stmt_98_c_mutex_);
}
...
{
MUTEX_DECL(_global_storage_initializer__series_block_stmt_182_c_mutex_);
MUTEX_LOCK(_global_storage_initializer__series_block_stmt_182_c_mutex_);
_global_storage_initializer__inner_inarg_prep_macro__; 
/* null */ ;
_global_storage_initializer__inner_outarg_prep_macro__; 
MUTEX_UNLOCK(_global_storage_initializer__series_block_stmt_182_c_mutex_);
}
...
{
MUTEX_DECL(_multiplyMatrixVector_series_block_stmt_185_c_mutex_);
MUTEX_LOCK(_multiplyMatrixVector_series_block_stmt_185_c_mutex_);
_multiplyMatrixVector_inner_inarg_prep_macro__; 
_multiplyMatrixVector_branch_block_stmt_186_c_export_decl_macro_; 
{
// merge  file .Aa/mvp.linked.aa, line 93
_multiplyMatrixVector_merge_stmt_187_c_preamble_macro_; 
// 			$phi R := 			  ($bitcast ($uint<8>) 0  ) $on   $entry 			  nR $on   loopback 
 // type of target is $uint<8>
_multiplyMatrixVector_phi_stmt_188_c_macro_; 
_multiplyMatrixVector_merge_stmt_187_c_postamble_macro_; 
// 		$call dotP_even (R ) (val_even ) 
_multiplyMatrixVector_call_stmt_196_c_macro_; 
// 		$call dotP_odd ((R + 1 ) ) (val_odd ) 
_multiplyMatrixVector_call_stmt_201_c_macro_; 
// 		y[R] := val_even $buffering 1// bits of buffering = 32. 
_multiplyMatrixVector_assign_stmt_205_c_macro_; 
// 		y[(R + 1 )] := val_odd $buffering 1// bits of buffering = 32. 
_multiplyMatrixVector_assign_stmt_211_c_macro_; 
// 		nR := (R + 1 ) $buffering 1// bits of buffering = 8. 
_multiplyMatrixVector_assign_stmt_216_c_macro_; 
// if statement :  file .Aa/mvp.linked.aa, line -379483272
__declare_static_bit_vector(konst_219,8);\
bit_vector_clear(&konst_219);\
konst_219.val.byte_array[0] = 32;\
__declare_static_bit_vector(ULT_u8_u1_220,1);\
bit_vector_clear(&konst_219);\
konst_219.val.byte_array[0] = 32;\
bit_vector_less(0, &(nR), &(konst_219), &(ULT_u8_u1_220));\
if (has_undefined_bit(&ULT_u8_u1_220)) {fprintf(stderr, "Error: variable ULT_u8_u1_220 has undefined value (%s) at test point.\n", to_string(&ULT_u8_u1_220));assert(0);} \

if (bit_vector_to_uint64(0, &ULT_u8_u1_220)) { 
/* 			$place[loopback]
*/  goto loopback_186;
} 
else {
...
_multiplyMatrixVector_branch_block_stmt_186_c_export_apply_macro_;
}
_multiplyMatrixVector_inner_outarg_prep_macro__; 
MUTEX_UNLOCK(_multiplyMatrixVector_series_block_stmt_185_c_mutex_);
}
...
void _mvp_daemon_()
{
MUTEX_DECL(_mvp_daemon_series_block_stmt_369_c_mutex_);
MUTEX_LOCK(_mvp_daemon_series_block_stmt_369_c_mutex_);
_mvp_daemon_inner_inarg_prep_macro__; 
// 	$call readMatrix () () 
_mvp_daemon_call_stmt_370_c_macro_; 
_mvp_daemon_branch_block_stmt_371_c_export_decl_macro_; 
{
// merge  file .Aa/mvp.linked.aa, line 187
_mvp_daemon_merge_stmt_372_c_preamble_macro_; 
_mvp_daemon_merge_stmt_372_c_postamble_macro_; 
// 		$call readVector () () 
_mvp_daemon_call_stmt_373_c_macro_; 
// 		$call multiplyMatrixVector () () 
_mvp_daemon_call_stmt_374_c_macro_; 
// 		$call sendVector () () 
_mvp_daemon_call_stmt_375_c_macro_; 
/* 		$place[loopback]
*/  goto loopback_371;
_mvp_daemon_branch_block_stmt_371_c_export_apply_macro_;
}
_mvp_daemon_inner_outarg_prep_macro__; 
MUTEX_UNLOCK(_mvp_daemon_series_block_stmt_369_c_mutex_);
}
void mvp_daemon()
{
...
void _readMatrix_()
{
MUTEX_DECL(_readMatrix_series_block_stmt_225_c_mutex_);
MUTEX_LOCK(_readMatrix_series_block_stmt_225_c_mutex_);
_readMatrix_inner_inarg_prep_macro__; 
_readMatrix_branch_block_stmt_226_c_export_decl_macro_; 
{
// merge  file .Aa/mvp.linked.aa, line 114
_readMatrix_merge_stmt_227_c_preamble_macro_; 
// 			$phi I := 			  ($bitcast ($uint<8>) 0  ) $on   $entry 			  nI $on   outer_loopback 
 // type of target is $uint<8>
_readMatrix_phi_stmt_228_c_macro_; 
_readMatrix_merge_stmt_227_c_postamble_macro_; 
// 		nI := (I + 1 ) $buffering 1// bits of buffering = 8. 
_readMatrix_assign_stmt_238_c_macro_; 
// merge  file .Aa/mvp.linked.aa, line 119
_readMatrix_merge_stmt_239_c_preamble_macro_; 
// 			$phi J := 			  ($bitcast ($uint<8>) 0  ) $on   $entry 			  nJ $on   inner_loopback 
 // type of target is $uint<8>
_readMatrix_phi_stmt_240_c_macro_; 
_readMatrix_merge_stmt_239_c_postamble_macro_; 
// 		nJ := (J + 1 ) $buffering 1// bits of buffering = 8. 
_readMatrix_assign_stmt_250_c_macro_; 
// 		$volatile odd_idx := (J [] 0 ) $buffering 1
_readMatrix_assign_stmt_255_c_macro_; 
// 		Jr := ( $slice J 7 1 )  $buffering 1// bits of buffering = 7. 
_readMatrix_assign_stmt_259_c_macro_; 
// 		aval := in_data $buffering 1// bits of buffering = 32. 
_readMatrix_assign_stmt_262_c_macro_; 
// 		$guard (odd_idx) A_1[I][Jr] := aval $buffering 1// bits of buffering = 32. 
_readMatrix_assign_stmt_268_c_macro_; 
// $guard (odd_idx) $report (readMatrix_odd odd_idx 		 I I 		 J J 		 Jr Jr 		 aval aval )
_readMatrix_stmt_274_c_macro_; 
// 		$guard (~odd_idx) A_0[I][Jr] := aval $buffering 1// bits of buffering = 32. 
_readMatrix_assign_stmt_280_c_macro_; 
// $guard (~odd_idx) $report (readMatrix_even even_idx 		 I I 		 J J 		 Jr Jr 		 aval aval )
_readMatrix_stmt_286_c_macro_; 
// if statement :  file .Aa/mvp.linked.aa, line 0
__declare_static_bit_vector(konst_289,8);\
bit_vector_clear(&konst_289);\
konst_289.val.byte_array[0] = 32;\
__declare_static_bit_vector(ULT_u8_u1_290,1);\
bit_vector_clear(&konst_289);\
konst_289.val.byte_array[0] = 32;\
bit_vector_less(0, &(nJ), &(konst_289), &(ULT_u8_u1_290));\
if (has_undefined_bit(&ULT_u8_u1_290)) {fprintf(stderr, "Error: variable ULT_u8_u1_290 has undefined value (%s) at test point.\n", to_string(&ULT_u8_u1_290));assert(0);} \

if (bit_vector_to_uint64(0, &ULT_u8_u1_290)) { 
/* 			$place[inner_loopback]
*/  goto inner_loopback_226;
} 
else {
 ;
}
// if statement :  file .Aa/mvp.linked.aa, line 0
__declare_static_bit_vector(konst_295,8);\
bit_vector_clear(&konst_295);\
konst_295.val.byte_array[0] = 32;\
__declare_static_bit_vector(ULT_u8_u1_296,1);\
bit_vector_clear(&konst_295);\
konst_295.val.byte_array[0] = 32;\
bit_vector_less(0, &(nI), &(konst_295), &(ULT_u8_u1_296));\
if (has_undefined_bit(&ULT_u8_u1_296)) {fprintf(stderr, "Error: variable ULT_u8_u1_296 has undefined value (%s) at test point.\n", to_string(&ULT_u8_u1_296));assert(0);} \

if (bit_vector_to_uint64(0, &ULT_u8_u1_296)) { 
/* 			$place[outer_loopback]
*/  goto outer_loopback_226;
} 
else {
 ;
}
_readMatrix_branch_block_stmt_226_c_export_apply_macro_;
}
_readMatrix_inner_outarg_prep_macro__; 
MUTEX_UNLOCK(_readMatrix_series_block_stmt_225_c_mutex_);
}
void readMatrix()
{
...
void _readVector_()
{
MUTEX_DECL(_readVector_series_block_stmt_301_c_mutex_);
MUTEX_LOCK(_readVector_series_block_stmt_301_c_mutex_);
_readVector_inner_inarg_prep_macro__; 
_readVector_branch_block_stmt_302_c_export_decl_macro_; 
{
{
// do-while:   file .Aa/mvp.linked.aa, line 146
__declare_static_bit_vector(konst_340,8);\
bit_vector_clear(&konst_340);\
konst_340.val.byte_array[0] = 32;\
__declare_static_bit_vector(ULT_u8_u1_341,1);\
uint8_t do_while_entry_flag;
do_while_entry_flag = 1;
uint8_t do_while_loopback_flag;
do_while_loopback_flag = 0;
while(1) {
// merge  file .Aa/mvp.linked.aa, line 148
_readVector_merge_stmt_304_c_preamble_macro_; 
// 			$phi I := 			  ($bitcast ($uint<8>) 0  ) $on   $entry 			  nI $on   $loopback 
 // type of target is $uint<8>
_readVector_phi_stmt_305_c_macro_; 
_readVector_merge_stmt_304_c_postamble_macro_; 
// 			$volatile odd_idx := (I [] 0 ) $buffering 1
_readVector_assign_stmt_315_c_macro_; 
// 			$volatile I_idx := ( $slice I 7 1 )  $buffering 1
_readVector_assign_stmt_319_c_macro_; 
// 			temp_val := in_data $buffering 1// bits of buffering = 32. 
_readVector_assign_stmt_322_c_macro_; 
// 			$guard (odd_idx) x_1[I_idx] := temp_val $buffering 1// bits of buffering = 32. 
_readVector_assign_stmt_327_c_macro_; 
// 			$guard (~odd_idx) x_0[I_idx] := temp_val $buffering 1// bits of buffering = 32. 
_readVector_assign_stmt_332_c_macro_; 
// 			$volatile nI := (I + 1 ) $buffering 1
_readVector_assign_stmt_337_c_macro_; 
do_while_entry_flag = 0;
do_while_loopback_flag = 1;
bit_vector_clear(&konst_340);\
konst_340.val.byte_array[0] = 32;\
bit_vector_less(0, &(nI), &(konst_340), &(ULT_u8_u1_341));\
if (has_undefined_bit(&ULT_u8_u1_341)) {fprintf(stderr, "Error: variable ULT_u8_u1_341 has undefined value (%s) at test point.\n", to_string(&ULT_u8_u1_341));assert(0);} \

if (!bit_vector_to_uint64(0, &ULT_u8_u1_341)) break;
} 
}
_readVector_branch_block_stmt_302_c_export_apply_macro_;
}
_readVector_inner_outarg_prep_macro__; 
MUTEX_UNLOCK(_readVector_series_block_stmt_301_c_mutex_);
}
void readVector()
{
...
void _sendVector_()
{
MUTEX_DECL(_sendVector_series_block_stmt_344_c_mutex_);
MUTEX_LOCK(_sendVector_series_block_stmt_344_c_mutex_);
_sendVector_inner_inarg_prep_macro__; 
_sendVector_branch_block_stmt_345_c_export_decl_macro_; 
{
{
// do-while:   file .Aa/mvp.linked.aa, line 168
__declare_static_bit_vector(konst_365,8);\
bit_vector_clear(&konst_365);\
konst_365.val.byte_array[0] = 32;\
__declare_static_bit_vector(ULT_u8_u1_366,1);\
uint8_t do_while_entry_flag;
do_while_entry_flag = 1;
uint8_t do_while_loopback_flag;
do_while_loopback_flag = 0;
while(1) {
// merge  file .Aa/mvp.linked.aa, line 170
_sendVector_merge_stmt_347_c_preamble_macro_; 
// 			$phi I := 			  ($bitcast ($uint<8>) 0  ) $on   $entry 			  nI $on   $loopback 
 // type of target is $uint<8>
_sendVector_phi_stmt_348_c_macro_; 
_sendVector_merge_stmt_347_c_postamble_macro_; 
// 			out_data := y[I] $buffering 1// bits of buffering = 32. 
_sendVector_assign_stmt_357_c_macro_; 
// 			$volatile nI := (I + 1 ) $buffering 1
_sendVector_assign_stmt_362_c_macro_; 
do_while_entry_flag = 0;
do_while_loopback_flag = 1;
bit_vector_clear(&konst_365);\
konst_365.val.byte_array[0] = 32;\
bit_vector_less(0, &(nI), &(konst_365), &(ULT_u8_u1_366));\
if (has_undefined_bit(&ULT_u8_u1_366)) {fprintf(stderr, "Error: variable ULT_u8_u1_366 has undefined value (%s) at test point.\n", to_string(&ULT_u8_u1_366));assert(0);} \

if (!bit_vector_to_uint64(0, &ULT_u8_u1_366)) break;
} 
}
_sendVector_branch_block_stmt_345_c_export_apply_macro_;
}
_sendVector_inner_outarg_prep_macro__; 
MUTEX_UNLOCK(_sendVector_series_block_stmt_344_c_mutex_);
}
void sendVector()
{

...
#define _mvp_daemon_call_stmt_586_c_macro_ _readVector_();\
;

#define _mvp_daemon_call_stmt_587_c_macro_ _multiplyMatrixVector_();\
;

#define _mvp_daemon_call_stmt_588_c_macro_ _sendVector_();\
;
;
